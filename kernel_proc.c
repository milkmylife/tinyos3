...
/*
  This function is provided as an argument to spawn,
  to execute some secondary thread of a process.
*/
void auxiliary_start_thread() 
{
  int exitval;
...
Pid_t sys_Exec(Task call, int argl, void* args)
{
  ...
  if(call != NULL) {
    ...
    newproc->main_thread = spawn_thread(newproc,start_main_thread);  //we create main thread
