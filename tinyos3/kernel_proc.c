...
void auxiliary_start_thread() // we need this in order to make this whole thing take into account the ptcb struct
{
  int exitval;                // it essentially works like start main thread but 
